...
Memory::Memory(){
    ...
    featureRedundancyTreshold_L2 = 0.010;
...
void Memory::checkRedundancy_L2(vector<int>& featsIdx)
{
	...
	for(size_t i = 0; i < featsIdx.size(); i++)
	{
							  	  ...
							  	  it != featuresMetadata.end(); ++it) 
		{
			...
			{
				redistributeGlobalWeights_L2(featId, si, fixedSearchRadius_L2);
...
void Memory::redistributeGlobalWeights_L2(int toForget, const pcl::Histogram<153>* si, double searchRadius)
{
	double sumOfDistances = 0;
