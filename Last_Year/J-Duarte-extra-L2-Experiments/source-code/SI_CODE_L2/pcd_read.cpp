...
char runTest(Memory& memory, TestResult& testResult){
	...
	memory.checkRedundancy_L2(featsIdx);
	//return 3;
    }
    ...
    */
    ...
    for(int j = 0; j < numberOfTests; j++){
		...
		*/
		...
		cout << "\t" << "Search Radius: " << memory.getSearchRadius() << endl;
		cout << "\t" << "Redundancy Treshold: " << memory.getRedundancyTreshold() << endl;
		cout << "\t" << "Lookup Table Size: " << memory.getLookupTableSize() << endl;
