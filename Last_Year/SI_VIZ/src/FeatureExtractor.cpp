...
void FeatureExtractor::GetKeypointsUsingAVoxelFilter(const PointCloud<PointT>::Ptr& pc, 
...
void FeatureExtractor::ComputeSpinImagesAtKeypoints(PointCloud<PointT>::Ptr &search_surface, 
...
void FeatureExtractor::ComputeSurfaceNormals(PointCloud<PointT>::Ptr &pc, float normal_radius,
